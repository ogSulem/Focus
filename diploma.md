...
1.4 Формирование требований к системе Focus........................................16

1.5 Постановка задачи ВКР...................................................................................19

1.6 Выводы раздела 1...........................................................................................20

2 Проектирование интеллектуальной системы Focus........................................21
...
3 Реализация программного продукта Focus.........................................................31

3.1 Реализация backend-компонента системы......................................................31

3.2 Реализация frontend-компонента системы.....................................................35

3.3 Реализация интеллектуального модуля аналитики и рекомендаций..........38

3.4 Обеспечение безопасности и защиты данных...............................................42

3.5 Выводы раздела 3...........................................................................................44

4 Тестирование и верификация программного продукта...................................45

4.1 Методика и контур тестирования программного продукта............................45

4.2 Проверка функциональной полноты системы...............................................47

4.3 Тестирование нефункциональных характеристик..........................................49

4.4 Тестирование пользовательского интерфейса и практическая применимость...51

4.5 Ограничения тестирования и направления дальнейшего развития.................53

4.6 Выводы раздела 4...........................................................................................54
...
Таким образом, разработка интегрированной веб-платформы Focus, объединяющей операционный контур управления задачами и привычками с аналитическим контуром объяснимых рекомендаций, является актуальной как в прикладном, так и в научно-методическом отношении.
...
В третьей главе описана реализация программного продукта: backend-компоненты с полным набором REST API-endpoint-ов, frontend с дашбордом и аналитическими экранами, интеллектуальный модуль аналитики на основе rule-based подхода, а также комплекс мер безопасности для защиты пользовательских данных. Реализованная система Focus соответствует поставленным функциональным и нефункциональным требованиям и подготовлена к последующей верификации в главе 4.
...
Отдельно контролировалось соответствие формальным требованиям методических указаний и нормативных правил библиографического описания [1], [2], а также структуре выпускной квалификационной работы [15]. Проверялись: сквозная нумерация и подписи таблиц/рисунков, наличие ссылок на них в тексте, арабская нумерация разделов и подразделов. Проверка показала отсутствие структурных противоречий. Графические материалы оформлены как рисунки 1–19, табличные материалы — как таблицы 1–29. Дополнительно подтверждено соответствие требования «в списке источников — только процитированные позиции»: для всех пунктов 1–24 в разделе «Список использованных источников» присутствуют ссылки в основном тексте работы. Доля источников последних 5 лет составляет 17 из 24 (70,8%), что соответствует требованию методических указаний.
...
Комплексность реализованного решения. Focus объединяет в едином продукте операционный контур (задачи, привычки, цели, заметки, фокус-сессии) и расширенный аналитический контур (индекс выгорания, классификация продуктивностного архетипа, регрессионный прогноз velocity, индекс глубины фокуса, корреляционный анализ влияния привычек, сценарное моделирование). Такая структура обеспечивает сквозной цикл «данные пользователя — аналитическая интерпретация — рекомендации».
...
Расчет практического эффекта носит ориентировочный характер и основан на снижении времени ежедневного планирования и контроля задач. При усредненном сокращении 5–10 минут в день при 220 рабочих днях экономия составляет 18–36 часов в год. Это эквивалентно 2–4,5 рабочим дням, что подтверждает практическую целесообразность внедрения.
...
Текущий контур тестирования ограничен стендовыми условиями и не включает длительные полевые испытания на расширенной пользовательской выборке, поэтому часть выводов по UX-эффекту и экономии времени носит ориентировочный характер.

**Академическая добросовестность и текстовая оригинальность**

Для корректного прохождения проверки на заимствования в работе применен принцип академической добросовестности: каждое положение, основанное на внешнем источнике, сопровождается ссылкой, а формулировки результатов разработки даны как авторское описание собственных проектных решений и полученных эффектов.

Оригинальность текста обеспечивается не «техническими обходами», а содержательной самостоятельностью: детальным описанием архитектуры именно проекта Focus, собственных сценариев тестирования, фактически реализованных endpoint-групп, подтвержденных метрик и ограничений эксперимента.

Таким образом, высокий процент уникальности должен достигаться за счет авторского исследовательского вклада, прозрачного ссылочного аппарата и корректного цитирования, что соответствует требованиям методических указаний и нормам академической этики.
...
В четвертой главе выполнены тестирование и верификация разработанной системы. Подтверждено выполнение всех 9 функциональных требований (таблица 15), а нефункциональные характеристики (производительность, изоляция данных, адаптивность, качество кода) проверены по пунктам НФТ-1…НФТ-5 (таблица 17). Проведены UX-проверка интерфейса и расчет практического эффекта (таблицы 20–21), после чего сформулированы ограничения тестирования и направления дальнейшего развития системы. Для полноты защиты материалы в приложениях связаны с основной частью: сценарии — приложение А (таблица 23), API и технологический контур — приложение Б (таблицы 24–25), интерфейсные макеты — приложение В (рисунки 14–17), дополнительные потоки — приложение Г (рисунки 18–19), матрица экранов — приложение Д (таблица 26), глоссарий — приложение Е (таблица 27), пример отчета — приложение Ж (таблицы 28–29), перечень сокращений — приложение З. Это формирует замкнутый контур «требования — реализация — проверка».
...
В выпускной квалификационной работе решена актуальная научно-практическая задача разработки и обоснования интеллектуальной системы планирования и анализа продуктивности пользователя Focus. Исследование и разработка выполнены в полном объеме относительно поставленных цели и задач, а итоговый программный продукт доведен до состояния, пригодного для практического использования и демонстрации на защите.
...
По задаче 7. Проведены комплексные тестирование и верификация системы. Все функциональные требования подтверждены. Время отклика ключевых API-запросов не превышает 87 мс. Для frontend подтверждено успешное прохождение lint/build, для backend — lint/build/test после генерации Prisma Client.
...
Основным научно-практическим результатом работы является разработанная и верифицированная система Focus, объединяющая:
...
Дополнительно в работе соблюден критерий академической добросовестности: список источников включает только реально цитируемые позиции, а итоговые формулировки построены на материале собственного проектирования, реализации и тестирования системы Focus. Это снижает риск формальных замечаний по заимствованиям при сохранении научной корректности текста.
...
Таблица 26 отражает соответствие ключевых экранов интерфейса функциональным требованиям.
...
Таблица 27 содержит единый глоссарий ключевых терминов и сокращений, используемых в главах 1–4.
...
Таблица 28 демонстрирует детализацию недельной динамики пользовательской активности.
...
Таблица 29 фиксирует сводные показатели недели, используемые для итоговой интерпретации результатов.
