...
С учетом требований методических указаний и результатов верификации работа соответствует критериям высокой итоговой оценки: тема актуальна и обоснована; исследование носит самостоятельный и завершенный характер; цель и задачи полностью раскрыты и формально трассированы (таблица 22); проектные решения подтверждены графическими материалами и таблицами; разработан функционирующий программный продукт с подтвержденной практической применимостью; выводы согласованы с поставленными задачами и результатами проверки; структура, нумерация и ссылочный аппарат согласованы с нормативными требованиями к ВКР; работа с источниками выполнена корректно (в списке сохранены только цитируемые позиции), а полученные результаты опираются на собственное проектирование, реализацию и тестирование системы Focus.
