...
**SWOT-анализ решения NeuroTrack**
...
Рисунок 1. Диаграмма вариантов использования системы NeuroTrack
...
Рисунок 2. Дерево целей и подцелей проекта NeuroTrack
...
Рисунок 3. Архитектурно-технологическая схема системы NeuroTrack
...
Рисунок 4. ER-диаграмма модели данных системы NeuroTrack (8 сущностей)
...
Рисунок 5. Модульная структура backend-ядра NeuroTrack
...
Рисунок 6. Схема маршрутов frontend-приложения NeuroTrack
...
Рисунок 7. Композиция главного экрана NeuroTrack
...
Рисунок 10. Контекстная C4-диаграмма взаимодействия внешних акторов с системой NeuroTrack
...
Рисунок 11. Диаграмма развертывания NeuroTrack в контейнерной инфраструктуре
...
Отдельно контролировалось соответствие формальным требованиям методических указаний и нормативных правил библиографического описания [1], [2], а также структуре выпускной квалификационной работы [15]. Проверялись: сквозная нумерация и подписи таблиц/рисунков, наличие ссылок на них в тексте, арабская нумерация разделов и подразделов. Проверка показала отсутствие структурных противоречий. Графические материалы оформлены как рисунки 1–19, табличные материалы — как таблицы 1–30. Дополнительно подтверждено соответствие требования «в списке источников — только процитированные позиции»: для всех пунктов 1–24 в разделе «Список использованных источников» присутствуют ссылки в основном тексте работы. Доля источников последних 5 лет составляет 17 из 24 (70,8%), что соответствует требованию методических указаний.
...
Дополнительные пользовательские потоки представлены в приложении Г (рисунки 18–19), а матрица соответствия экранов и требований — в приложении Д (таблица 27).
...
**UX-оценка по эвристикам Нильсена**
...
| Реализация backend/frontend компонентов | Реализован полный контур REST API и пользовательского интерфейса | Разделы 2.4–2.5, рисунки 5 и 6, таблица 9 |
| Реализация интеллектуального модуля рекомендаций | Внедрен IntelligenceService с объяснимыми рекомендациями | Раздел 2.6, рисунок 9 |
| Оценка качества и практической применимости | Подтверждена функциональная полнота, НФТ и прикладная ценность | Раздел 3.1–3.4, таблицы 15–21 |
...
На рисунках 14–17 представлены ключевые экраны пользовательского интерфейса NeuroTrack.

![Скриншот дашборда](assets/screens/dashboard.svg)

Рисунок 14. Экран дашборда с KPI и рекомендациями

![Скриншот канбан-доски](assets/screens/kanban.svg)

Рисунок 15. Экран канбан-доски со статусами задач

![Скриншот аналитики](assets/screens/analytics.svg)

Рисунок 16. Экран аналитики с графиком и heatmap

![Скриншот режима концентрации](assets/screens/focus.svg)

Рисунок 17. Экран режима концентрации (Pomodoro)
