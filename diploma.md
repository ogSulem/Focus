...
![Макет дашборда](assets/screens/dashboard.svg)

Рисунок 14. Макет дашборда с KPI и рекомендациями

![Макет канбан-доски](assets/screens/kanban.svg)

Рисунок 15. Макет канбан-доски со статусами задач

![Макет аналитики](assets/screens/analytics.svg)

Рисунок 16. Макет экрана аналитики с графиком и heatmap

![Макет режима концентрации](assets/screens/focus.svg)

Рисунок 17. Макет экрана режима концентрации (Pomodoro)
